...
def train_lora(
        ...
        output_dir="lora_laion_vwsd_text_lora_G14",
        lr=1e-5,
        epochs=1,
        limit_train=500
):
    ...
    # only train logit_scale + text_model LoRA
    ...
    lora_cfg = LoraConfig(
        ...
        lora_dropout=0.1,
        target_modules=[
            "q_proj", "k_proj", "v_proj", "out_proj", "fc1", "fc2"                      # MLP
        ],
        bias="none"
    )
    ...
    for epoch in range(epochs):
        ...
        for i in progress:
            ...
            img_in = processor(images=imgs, return_tensors="pt", padding = True)
